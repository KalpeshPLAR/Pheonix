...
`;var g=i(1217);let f=new class Assets{load(e){Promise.all([...this.loadImages(),...this.loadGltfs()]).then(()=>{e&&e()})}loadGltfs(){let e=new g.E;return Object.values(this.gltfs).map(t=>new Promise((i,n)=>{e.load(t.src,e=>{t.scene=e.scene,i(e.scene)},void 0,e=>n(e))}))}loadImages(){let e=new s.dpR;return Object.values(this.images).map(t=>new Promise((i,n)=>{e.load(t.src,e=>{t.texture=e,e.flipY=t.flipY,t.encoding&&(e.encoding=t.encoding),i(e)},void 0,e=>n(e))}))}constructor(){let e="/images/modules/site/lab/";this.images={bakedGoggle:{src:`${e}bakedGoggle.png`,texture:null,flipY:!1,encoding:s.knz},bakedHead:{src:`${e}bakedHead.png`,texture:null,flipY:!1,encoding:s.knz},bakedOther:{src:`${e}bakedOther.png`,texture:null,flipY:!1,encoding:s.knz},matcap:{src:`${e}matcap.png`,texture:null,flipY:!0}},this.gltfs={head:{src:`${e}copilot.glb`,scene:null}}}},y=class CopilotHead{init(){this.addMeshes(),this.createAnimations()}addMeshes(){let e=[];if(f.gltfs.head.scene)for(let t of(f.gltfs.head.scene.traverse(t=>{if(t.isMesh){let i;switch(t.name){case"Goggle":case"LeftEye":case"RightEye":case"Glass001":i=f.images.bakedGoggle.texture;break;case"HeadBase":i=f.images.bakedHead.texture;break;case"Screen":i=f.images.bakedOther.texture}let n="HeadBase"===t.name,s="RightEye"===t.name||"LeftEye"===t.name;switch(t.material=this.createMaterial(i,n,s),t.name){case"Goggle":case"Glass001":e.push({object:t,isGoggle:!0});break;default:e.push({object:t,isFace:!0})}"RightEye"===t.name?this.eyesMeshes.right=t:"LeftEye"===t.name&&(this.eyesMeshes.left=t)}}),e)){let e=t.object;e.parent&&e.parent.remove(e),t.isGoggle&&this.goggleGroup.add(e),t.isFace&&this.faceGroup.add(e)}}createMaterial(e,t,i){let n={uWink:{value:0}},a=new s.kaV({map:e,matcap:f.images.matcap.texture,transparent:!0});return a.onBeforeCompile=e=>{e.uniforms={...e.uniforms,...this.uniforms,uFresnelIntensity:{value:t?1:0},uIsEye:{value:i},...n},e.vertexShader=d,e.fragmentShader=p},a.userData.uniforms=n,a}createAnimations(){this.animations=new m({group:this.group,animationGroup:this.animationGroup,goggleGroup:this.goggleGroup,faceGroup:this.faceGroup,eyesMeshes:this.eyesMeshes}),o.addMousemoveFunc(this.raycast.bind(this)),document.body.addEventListener("click",()=>{this.isRaycastHit&&this.animations.createClickAnimation()})}raycast(){this.raycaster.setFromCamera(o.pos.target,a.camera),this.raycaster.intersectObject(this.group).length>0?this.isRaycastHit=!0:this.isRaycastHit=!1}update(){this.breathing.rotation=.05*Math.sin(2*a.time),this.breathing.position=.08*Math.sin((a.time+.25)*2);let e=o.pos.target.length();this.mouseIntensity.target=n(3,1.3,e),this.mouseIntensity.current+=(this.mouseIntensity.target-this.mouseIntensity.current)*a.getEase(3),this.lookatTarget.set(.5*o.pos.current.x,.5*o.pos.current.y,1),this.lookatTarget.lerp(this.lookatTarget_default,1-this.mouseIntensity.current),this.lookatTarget.y+=this.breathing.rotation,this.orientationGroup.lookAt(this.lookatTarget),this.orientationGroup.position.y=this.breathing.position;let t=n(0,.5,o.pos.current2.y);for(let e in t=Math.min(t=0+(t-0)*this.mouseIntensity.current+(this.breathing.rotation+1)*1.2,1),this.goggleGroup.userData.rotateX.orientation=.1+-.18*t,this.goggleGroup.rotation.x=0,this.goggleGroup.userData.rotateX){let t=this.goggleGroup.userData.rotateX[e];this.goggleGroup.rotation.x+=t}}constructor(){this.group=new s.ZAu,this.group.visible=!1,this.group.scale.set(.01,.01,.01),this.group.position.y,this.orientationGroup=new s.ZAu,this.animationGroup=new s.ZAu,this.group.add(this.orientationGroup),this.orientationGroup.add(this.animationGroup),this.goggleGroup=new s.ZAu,this.faceGroup=new s.ZAu,this.animationGroup.add(this.goggleGroup),this.animationGroup.add(this.faceGroup),this.eyesMeshes={left:null,right:null},this.breathing={rotation:0,position:0},this.goggleGroup.userData.rotateX={orientation:0,anim_rotating:0},this.lookatTarget=new s.Pa4,this.lookatTarget_default=new s.Pa4(-.4,-.2,1),this.raycaster=new s.iMs,this.isRaycastHit=!1,this.mouseIntensity={target:0,current:0},this.uniforms={fresnelBias:{value:.01},fresnelScale:{value:2},fresnelPower:{value:3}}}};var v=i(36071);let k={width:500,height:500},_=!1;(0,v.N7)(".js-copilot-head",e=>{let t=e.getBoundingClientRect();k.width=t.width,k.height=t.height;let i=document.querySelector(".js-copilot-head-wrapper");a.init(i,e),r.init(),o.init();let n=new y;_||f.load(()=>{n.init(),_=!0}),a.scene.add(n.group),window.addEventListener("resize",()=>{a.resize()}),window.addEventListener("scroll",()=>{a.resize()});let s=()=>{a.update(),o.update(),n.update(),a.renderer.render(a.scene,a.camera),window.requestAnimationFrame(s)};s()})}},e=>{var t=t=>e(e.s=t);e.O(0,["vendors-node_modules_github_selector-observer_dist_index_esm_js","vendors-node_modules_three_build_three_module_js","vendors-node_modules_three_examples_jsm_loaders_GLTFLoader_js"],()=>t(75251)),e.O()}]);
//# sourceMappingURL=marketing-copilot-head-923282c7a4d8.js.map